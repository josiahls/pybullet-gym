...
class PickAndPlaceMJCFScene(Scene):
    multiplayer = False
    ...
    def episode_restart(self, bullet_client):
        ...
        if self.stadiumLoaded == 0:
            ...
            filename = os.path.join(os.path.dirname(__file__), "..", "assets", "mjcf", "scenes", "object_manipulation",
                                    "pick_and_place.xml")
            self.ground_plane_mjcf = self._p.loadMJCF(filename)
